...
hpaSecretome <- hpaSecretome()

gtex_dir <- "02_out"
gtex_vst_combat <- readRDS(file.path(gtex_dir, "gtexv8_vst_combat4_dds.Rds"))
...
saveRDS(plierResults_gtexVstCombatNoSec_bloodCell_svm_canonicalPathways, 
        file.path(out_dir, "GTExv8VSTcomBATAgeCorrNoSecretome_canonicalPathwaysBloodCellSVM_multiplier_v2.Rds")
)
